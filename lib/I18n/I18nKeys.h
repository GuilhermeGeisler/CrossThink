...
enum class StrId : uint16_t {
  ...
  STR_DICT_INDEX_PROMPT_TITLE,
  STR_DICT_INDEX_PROMPT_BODY,
  STR_DICT_NOT_FOUND_TITLE,
  STR_DICT_NOT_FOUND_BODY,
  STR_HIGHLIGHT_START,
  STR_HIGHLIGHT_END,
  STR_HIGHLIGHT_HOLD,
  STR_PRESS_CONFIRM_SUGGESTIONS,
  STR_SCROLL,
  STR_LOW_MEMORY_LOOKUP_TITLE,
  STR_LOW_MEMORY_LOOKUP_BODY,
  STR_NEXT,
  STR_PREV,
  STR_UP_DOWN,
  STR_FINISHED_BOOKS,
  STR_PET_CAT_ADOLESCENT,
  STR_PET_CAT_ADULT,
  STR_PET_CAT_KITTEN,
  STR_PET_DRAGON_ADULT,
  STR_PET_DRAGON_EGG,
  STR_PET_DRAGON_ELDER,
  STR_PET_DRAGON_HATCHLING,
  STR_PET_DRAGON_JUVENILE,
  STR_PET_EVOLVED,
  STR_PET_TIGER_ADOLESCENT,
  STR_PET_TIGER_ADULT,
  STR_PET_TIGER_CUB,
  STR_REMOVE_FROM_STATS,
  STR_READING_STATS,
  STR_STATS_ALL_TIME,
  STR_STATS_BADGES,
  STR_STATS_BOOKS,
  ...
  STR_STATS_HAPPINESS,
  STR_STATS_HOURS,
  STR_STATS_HOURS_READ,
  STR_STATS_HUNGER,
  STR_STATS_LONGEST,
  STR_STATS_LONGEST_STREAK,
  STR_STATS_NIGHT,
  STR_STATS_NO_DATA,
  STR_STATS_PAGES,
  STR_STATS_PAGES_TURNED,
  STR_STATS_PET,
  STR_STATS_PET_LEVEL,
  STR_STATS_PET_MAX,
  STR_STATS_PET_RESTING,
  STR_STATS_PET_THRIVING,
  STR_STATS_SESSIONS_COUNT,
  STR_STATS_STREAK,
  STR_STATS_SYNC_TIME,
  STR_STATS_TIME_SPENT,
  STR_STATS_TITLE,
  STR_STATS_TODAY,
  STR_STATS_VIEW_FINISHED,
  STR_STATS_VIEW_READING,
  STR_STATS_WRAPPED,
  STR_STATS_XP,
