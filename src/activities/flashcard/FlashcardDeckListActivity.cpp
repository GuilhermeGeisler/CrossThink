...
void FlashcardDeckListActivity::render(RenderLock&&) {
  ...
  renderer.drawText(UI_10_FONT_ID, sidePad + 8, y + 12, tr(STR_FLASHCARD_IMPORT), selectedIndex != importIdx);
  y += actionRowHeight + 4;
  ...
  renderer.drawText(UI_10_FONT_ID, sidePad + 8, y + 12, tr(STR_FLASHCARD_SETTINGS), selectedIndex != settingsIdx);
